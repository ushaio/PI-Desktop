...
export const fr = {
  ...
  "updates": {
    ...
    "autoUpdate": "Vérification automatique des mises à jour",
    "autoUpdateDesc": "GitHub Releases est vérifié en arrière-plan. La vérification manuelle reste disponible."
  },
  "nav": {
